...
export declare function LineChartTooltip({ children, xGutter, yGutter, cursorGutter, position, textProps, textStyle, at, ...props }: LineChartTooltipProps): import("react/jsx-runtime").JSX.Element;
