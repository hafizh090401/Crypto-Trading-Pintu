...
export declare const CandlestickChart: typeof _CandlestickChart & {
    Candle: ({ candle, maxHeight, domain, margin, positiveColor, negativeColor, rectProps: overrideRectProps, lineProps: overrideLineProps, index, width, useAnimations, renderLine, renderRect, }: import("./Candle").CandlestickChartCandleProps) => import("react/jsx-runtime").JSX.Element;
    ...
    Line: ({ color, x, y, ...props }: import("./Line").CandlestickChartLineProps) => import("react/jsx-runtime").JSX.Element;
